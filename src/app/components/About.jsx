  ...
  return (
    <main className="bg-secondary h-screen flex flex-col justify-between px-56 gap-10 text-white">
        ...
        <p className="pb-96 text-white/40 text-lg text-justify">
            ...
            to reach my <span className="text-white/75">full potential</span>. therefore, given the <span className="text-white/75"> opportunity to study abroad in Canada</span>, i chose Computer Science. 
