        ...
        <div className="flex flex-row gap-2 ">
          <Link href='https://github.com/phuongwj' target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                  className="bg-gray-900 p-1 rounded-lg h-6.5 w-6.5 fill-first hover:fill-first/70 hover:opacity-45 transition duration-500">
      ...
      <main className="py-32 min-h-screen w-full max-w-xl mx-auto flex flex-col items-center gap-12">
        ...
        <section className="w-full">
          <h2 className="text-first text-2xl font-medium">
            originally from Saigon, Vietnam. In 2023, I chose to study abroad in Canada to pursue a degree in Computer Science. <span className="text-second">i'm passionate about learning and working in areas like Full-Stack, Cloud and Machine Learning.</span>
          </h2>
        </section>
        ...
        <section className="w-full">
          ...
          {/* Title */}
          <h1 className="text-first text-md font-medium underline underline-offset-4"> experience</h1>
