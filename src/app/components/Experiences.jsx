...
export default function Experiences() {
    ...
    return (
        <section className="relative group/bgg">
            ...
            <main className="relative flex flex-col gap-3 p-7 rounded-3xl shadow-xl bg-secondary border border-secondaryC transition duration-500 opacity-90 group-hover/bgg:opacity-100">
                <section className="flex flex-row gap-2 pb-1">
                    <section className="pt-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6 fill-white/80">
                    ...
                    <p className="font-bold text-xl text-white/80"> Experiences </p>
                </section>  
