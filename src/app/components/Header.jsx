          ...
          <div className="flex items-center gap-5 justify-center lg:justify-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link href='https://github.com/phuongwj' target="_blank">
                      <span className="text-first hover:text-[#0068e0] text-base font-medium">Github</span>
                  </Link>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link href='https://www.linkedin.com/in/phuongwj/' target="_blank">
                      <span className="text-first hover:text-[#0068e0] text-base font-medium">LinkedIn</span>
                  </Link>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a 
                    ...
                    alt="Phuong's Resume"
                    target="_blank"
                    className="text-first hover:text-[#0068e0] text-base font-medium"
                    >Resume</a>
                </div>
            </div>
          </div>
